...
# If install via brew then enable the following command
...
# Search and kill process by the given port
fport() {
  if [ ! "$#" -gt 0 ]; then echo "Need given a port to search for!"; return 1; fi
  sudo lsof -i :$1
}
...
source ~/.zshrc.personio

export PATH="${KREW_ROOT:-$HOME/.krew}/bin:$PATH"

# pnpm
export PNPM_HOME="/Users/sanght/Library/pnpm"
